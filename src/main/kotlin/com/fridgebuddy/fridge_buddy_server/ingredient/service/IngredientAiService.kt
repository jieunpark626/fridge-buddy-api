...
class IngredientAiService(
    ...
    private fun buildGenerationPrompt(keyword: String): String = """
        ...
        응답 형식:
        {
          ...
          "shelfLifeDaysFridge": 냉장 보관 시 유통기한 일수 (정수). 냉장 보관이 불가하면 null,
          "shelfLifeDaysFreezer": 냉동 보관 시 유통기한 일수 (정수). 냉동 보관이 불가하면 null,
          "shelfLifeDaysRoomTemp": 실온 보관 시 유통기한 일수 (정수). 실온 보관이 불가하면 null,
